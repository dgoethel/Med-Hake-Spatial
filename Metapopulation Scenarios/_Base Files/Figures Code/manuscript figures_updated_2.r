...
runs.to.include<-c(116,133,132,135,127,134,59,72,71,75,70,73,10,23,22,25,21,24,109,113,112,114,198,187)  # the numbers corresponding to the runs to include in the MRE summary plots
...
#Figure_dir<-"C:\\Users\\komori\\Desktop\\dan temp"
#Figure_table_dir<-"C:\\Users\\komori\\Desktop\\dan temp"

Figure_dir<-"D:\\NOAA FILES\\Outreach\\Journal Submissions\\2019\\Journal of Applied Ecology\\movement manuscript\\runs\\Figures\\Figures"
Figure_table_dir<-"D:\\NOAA FILES\\Outreach\\Journal Submissions\\2019\\Journal of Applied Ecology\\movement manuscript\\runs\\Figures\\tables"
...
#for (z in runs.to.include_brian){ # dir_num) {
  ...
  ssb_sum_table<-c(get(paste0("nm_",z)),get(paste0("conv.rate_",z)),ssb.est.med$MARE[2],ssb.est.med$MARE[32],ssb.est.med$MARE[62],ssb.est.med$MARE[30],ssb.est.med$MARE[60],ssb.est.med$MARE[90],
                   round(median(abs(ssb.est$bias[ssb.est$Reg=='1'])),digits=2),round(median(abs(ssb.est$bias[ssb.est$Reg=='2'])),digits=2),
                   round(median(abs(ssb.est$bias[ssb.est$Reg=='System'])),digits=2),
                   round(median(abs(ssb.est$bias)),digits=2),
                   ssb.est.med$MRE[2],ssb.est.med$MRE[32],ssb.est.med$MRE[62],ssb.est.med$MRE[30],ssb.est.med$MRE[60],ssb.est.med$MRE[90],
                   round(mean(ssb.est$bias[ssb.est$Reg=='1']),digits=2),round(mean(ssb.est$bias[ssb.est$Reg=='2']),digits=2),
                   round(mean(ssb.est$bias[ssb.est$Reg=='System']),digits=2),
                   round(mean(ssb.est$bias),digits=2))
  names(ssb_sum_table)<-c("Run","Conv_Rate","MARE_Reg_1_YR_2","MARE_Reg_2_YR_2","MARE_Tot_YR_2","MARE_Reg_1_YR_30","MARE_Reg_2_YR_30","MARE_Tot_YR_30",
                          "MARE_YR_Reg_1","MARE_YR_Reg_2","MARE_YR_Total","MARE_YR+Reg",
                          "MRE_Reg_1_YR_2","MRE_Reg_2_YR_2","MRE_Tot_YR_2","MRE_Reg_1_YR_30","MRE_Reg_2_YR_30","MRE_Tot_YR_30","MRE_YR_Reg_1","MRE_YR_Reg_2","MRE_YR_Total",
                          "MRE_YR+Reg")
  ...
  ssb.plot.gg<-ggplot(ssb.est, aes(x=as.factor(Years), y=value)) +
    ...
    scale_x_discrete(breaks=seq(0,nyrs,5))+
    ggtitle(get(paste0("nm_",z)))+
    labs(subtitle=paste0("Convergence Rate = ", get(paste0("conv.rate_",z)),sep=""))+  ylab("SSB")+
    xlab("Year")+
    facet_grid(Reg~.)+
    ylim(0,150000)+
    my_theme
  ...
  ssb.name<-c('Syste,'="Metapopulation ssbmass")
  ssb.plot.gg.fig5a<-ggplot(subset(ssb.est, Reg %in% 'System'), aes(x=as.factor(Years), y=value)) +
    geom_violin(fill='gray',trim=T,bw="nrd0", alpha=0.6,scale='width')+
    geom_point(data = subset(ssb.est.med, Reg %in% 'System'), aes(x=Years,y=med.est), fill='black', colour='black',shape=20,size=.75) + 
    geom_line(data =subset(ssb.est.med, Reg %in% 'System'), aes(x=Years,y=med.sim),lty=1) + 
    scale_x_discrete(breaks=seq(0,nyrs,5))+
    ggtitle(get(paste0("nm_",z)))+
    #labs(subtitle=paste0("Convergence Rate = ", get(paste0("conv.rate_",z)),sep=""))+  
    ylab('SSB (mt)')+
  ...
  assign(paste0("ssb.plot.gg_",z),ssb.plot.gg)
  assign(paste0("ssb.plot.gg.fig5a_",z),ssb.plot.gg.fig5a)
  assign(paste0("ssb.bias.gg_",z),ssb.bias.gg)
  assign(paste0("ssb.est.med_",z),ssb.est.med)
  assign(paste0("ssb.est_",z),ssb.est)
  assign(paste0("ssb.sum.table_",z),as.data.frame(t(ssb_sum_table)))
  ...
  ssb.table<-spread(bio.long, key = variable, value = value)
  ...
  write.csv(ssb_ts,paste0("ssb_ts_",z,".csv"))
  write.csv(ssb.table,paste0("ssb_table_",z,".csv"))
...
ssb.summary<-sapply(dir_num, function(i) list(get(paste0("ssb.sum.table_",i))))
ssb.summary<-rbindlist(ssb.summary)
write.csv(ssb.summary,"SSB MARE and MRE.csv")
...
MRE.ssb.graph<-sapply(dir_num, function(i) list(get(paste0("ssb.est_",i))))
names(MRE.ssb.graph)<-sapply(dir_num, function(i) get(paste0("nm_",i)))
...
tiff("Fig 1_Timeseries True Values_B+W.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(true.ts)
dev.off()
...
tiff("Fig 1_Timeseries True Values_color.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(true.ts)
dev.off()
...
tiff("Fig 2_Timeseries True Movement_B+W.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(true.ts1)
dev.off()
...
tiff("Fig 2_Timeseries True Movement_color.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(true.ts1)
dev.off()
...
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_YR+AG","ONT_AGE","CLM_YR","C+O_2YR+2AG"))
...
tiff("Fig Timeseries Bio Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(116,133,132,135,127,134)
bio.med.bias<-sapply(dir_num, function(i) list(get(paste0("bio.ts_",i))))
bio.med.bias<-rbindlist(bio.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
bio.med.bias2<-bio.med.bias[bio.med.bias$Scenario %in% names.keep.ts,]
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_NO_T","DD_CNST","DD_AGE","DD_YR","DD_2YR+2AG","DD_YR+AG"))
...
tiff("Fig alt_Timeseries Density Dependent.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("Fig alt_Timeseries Climate.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(10,23,22,25,21,24)
bio.med.bias<-sapply(dir_num, function(i) list(get(paste0("bio.ts_",i))))
bio.med.bias<-rbindlist(bio.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
bio.med.bias2<-bio.med.bias[bio.med.bias$Scenario %in% names.keep.ts,]
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("ONT_NO_T","ONT_CNST","ONT_AGE","ONT_YR","ONT_2YR+2AG","ONT_YR+AG"))
...
tiff("Fig alt_Timeseries Onto.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("Fig alt_Timeseries LIFE HISTORY Onto.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("C+O_NO_T","C+O_CNST","C+O_AGE","C+O_YR","C+O_2YR+2AG","C+O_YR+AG"))
...
tiff("Fig alt_Timeseries Onto+Clim.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(200,198,199,192,187,115)
bio.med.bias<-sapply(dir_num, function(i) list(get(paste0("bio.ts_",i))))
bio.med.bias<-rbindlist(bio.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
bio.med.bias2<-bio.med.bias[bio.med.bias$Scenario %in% names.keep.ts,]
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("C+O_2YR+2AG_NO_TAG","C+O_2YR+2AG","C+O_2YR+2AG_TAG_YR",
                                                               "C+O_YR+AG_NO_TAG","C+O_YR+AG","C+O_YR+AG_TAG_YR"))
...
tiff("Fig alt_Timeseries Onto+Clim YRLY TAG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(75,193,198,199,187,115)
bio.med.bias<-sapply(dir_num, function(i) list(get(paste0("bio.ts_",i))))
bio.med.bias<-rbindlist(bio.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
bio.med.bias2<-bio.med.bias[bio.med.bias$Scenario %in% names.keep.ts,]
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("CLM_YR","CLM_YR_TAG_YR","C+O_2YR+2AG","C+O_2YR+2AG_TAG_YR",
                                                               "C+O_YR+AG","C+O_YR+AG_TAG_YR"))
...
tiff("Fig alt_Timeseries YRLY TAG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_2YR+2AG","ONT_2YR+2AG","CLM_2YR+2AG","C+O_2YR+2AG"))
...
tiff("Fig alt_Timeseries 2YR_2AG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_NO_T","ONT_NO_T","CLM_NO_T","C+O_NO_T"))
...
tiff("Fig alt_Timeseries No T.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_YR+AG_NO_TAG","DD_YR+AG",
                                                               "ONT_AGE_NO_TAG","ONT_AGE",
...
tiff("Fig alt_Timeseries No Tags.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="1")]<-"Population 1"
bio.med.bias2$Reg[which(bio.med.bias2$Reg=="2")]<-"Population 2"
bio.med.bias2$Scenario<-factor(bio.med.bias2$Scenario,levels=c("DD_FIX_T",
                                                               "ONT_FIX_T",
                                                               "CLM_FIX_T",
                                                               "C+O_FIX_T"))
...
tiff("Fig alt_Timeseries FIX T.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
########################################################################################################
########################################################################################################
######## Figure 5 SSB Timeseries for Various Tag Timeseries################################################################################################
########################################################################################################
########################################################################################################
...
runs.to.include.ts<-c(22,134,75,198)
ssb.med.bias<-sapply(dir_num, function(i) list(get(paste0("ssb.ts_",i))))
...
tiff("Fig 3_Timeseries ssb Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(203,22,134,75,198)
ssb.med.bias<-sapply(dir_num, function(i) list(get(paste0("ssb.ts_",i))))
ssb.med.bias<-rbindlist(ssb.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
ssb.med.bias2<-ssb.med.bias[ssb.med.bias$Scenario %in% names.keep.ts,]
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("No_Move_CNST","DD_YR+AG","ONT_AGE","CLM_YR","C+O_2YR+2AG"))
...
tiff("Fig 3 ALT NO MOVE_Timeseries ssb Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("Fig 4 SSB_alt_Timeseries No T.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(201,116,10,109,59)
ssb.med.bias<-sapply(dir_num, function(i) list(get(paste0("ssb.ts_",i))))
ssb.med.bias<-rbindlist(ssb.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
ssb.med.bias2<-ssb.med.bias[ssb.med.bias$Scenario %in% names.keep.ts,]
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("No_Move_NO_T","DD_NO_T","ONT_NO_T","CLM_NO_T","C+O_NO_T"))
...
tiff("Fig 4 ALT NO MOVE SSB_alt_Timeseries No T.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("DD_NO_T","DD_CNST","DD_AGE","DD_YR","DD_2YR+2AG","DD_YR+AG"))
...
tiff("SSB Timeseries Density Dependent.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 6 SSB Timeseries Climate.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("ONT_NO_T","ONT_CNST","ONT_AGE","ONT_YR","ONT_2YR+2AG","ONT_YR+AG"))
...
tiff("SSB_Timeseries Onto.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 5 SSB_alt_Timeseries LIFE HISTORY Onto.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 7 SSB_alt_Timeseries Onto+Clim.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("C+O_2YR+2AG_NO_TAG","C+O_2YR+2AG","C+O_2YR+2AG_TAG_YR",
                                                               "C+O_YR+AG_NO_TAG","C+O_YR+AG","C+O_YR+AG_TAG_YR"))
...
tiff("SM SSB_alt_Timeseries YRLY TAG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("CLM_YR","CLM_YR_TAG_YR","C+O_2YR+2AG","C+O_2YR+2AG_TAG_YR",
                                                               "C+O_YR+AG","C+O_YR+AG_TAG_YR"))
...
tiff("SM Fig 3 SSB_alt_Timeseries YRLY TAG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 2 SSB_alt_Timeseries 2YR_2AG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.ts<-c(202,70,198,21,127)
ssb.med.bias<-sapply(dir_num, function(i) list(get(paste0("ssb.ts_",i))))
ssb.med.bias<-rbindlist(ssb.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
ssb.med.bias2<-ssb.med.bias[ssb.med.bias$Scenario %in% names.keep.ts,]
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("No_Move_2YR+2AG","DD_2YR+2AG","ONT_2YR+2AG","CLM_2YR+2AG","C+O_2YR+2AG"))
...
tiff("SM Fig 2 ALT NO MOVE SSB_alt_Timeseries 2YR_2AG.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 4 SSB_alt_Timeseries No Tags.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
tiff("SM Fig 8 SSB_alt_Timeseries FIX T.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()
...
runs.to.include.alt1<-c(116,10,59,109,133,23,72,113,132,22,71,112,135,25,75,114,124,18,67,110,127,21,70,198,134,24,73,187,136,26,76,115)  # the numbers corresponding to the runs to include in the MRE summary plots
...
##################################
tiff("SM_Fig_9_Density Dependent T Bias Plots All Years Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
#plot_grid( bio.plot.vert,rec.plot.vert,f.plot.vert, align = "hv", ncol = 3) #, rel_heights = c(1/4, 1/4, 1/2))
...
##################################
tiff("SM_Fig_10_Density Dependent T Bias Plots Terminal Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
#plot_grid( bio.plot.vert,rec.plot.vert,f.plot.vert, align = "hv", ncol = 3) #, rel_heights = c(1/4, 1/4, 1/2))
...
########################################################################################################
########################################################################################################
######### Density Dependent T Sensitivity ###############################################################################################
########################################################################################################
########################################################################################################

runs.to.include.alt1<-c(116,118,122,124,127,132:136,169:177,179:183)  # the numbers corresponding to the runs to include in the MRE summary plots
...
##################################
tiff("SM_Fig_11_Sensitivity Density Dependent T Bias Plots All Years Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
#plot_grid( bio.plot.vert,rec.plot.vert,f.plot.vert, align = "hv", ncol = 3) #, rel_heights = c(1/4, 1/4, 1/2))
...
##################################
tiff("SM_Fig_12_Sensitivity Density Dependent T Bias Plots Terminal Final.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
#plot_grid( bio.plot.vert,rec.plot.vert,f.plot.vert, align = "hv", ncol = 3) #, rel_heights = c(1/4, 1/4, 1/2))
...
runs.to.include.alt1<-c(139,146,118,127,155,162,31,38,14,22,47,54,84,91,66,75,100,107)  # the numbers corresponding to the runs to include in the MRE summary plots
...
grid.arrange(ncol = 2,
             top="Movement",
             move.plot.gg_198, move.plot.gg_112,move.plot.gg_114,move.plot.gg_115)


grid.arrange(ncol = 2,
             top="Recruitment",
             rec.plot.gg_198, rec.plot.gg_112,rec.plot.gg_114,rec.plot.gg_115)


grid.arrange(ncol = 2,
             top="Biomass",
             bio.plot.gg_198, bio.plot.gg_112,bio.plot.gg_114,bio.plot.gg_115)


grid.arrange(ncol = 2,
             top="Fishing Mortality",
             fmax.plot.gg_198, fmax.plot.gg_112,fmax.plot.gg_114,fmax.plot.gg_115)
...
grid.arrange(ncol = 2,
             top="Movement",
             move.bias.gg_198, move.bias.gg_112,move.bias.gg_114,move.bias.gg_115)


grid.arrange(ncol = 2,
             top="Recruitment",
             rec.bias.gg_198, rec.bias.gg_112,rec.bias.gg_114,rec.bias.gg_115)


grid.arrange(ncol = 2,
             top="Biomass",
             bio.bias.gg_198, bio.bias.gg_112,bio.bias.gg_114,bio.bias.gg_115)


grid.arrange(ncol = 2,
             top="Fishing Mortality",
             fmax.bias.gg_198, fmax.bias.gg_112,fmax.bias.gg_114,fmax.bias.gg_115)
...
grid.arrange(ncol = 2,
             top="Movement",
             move.plot.gg_127, move.plot.gg_22,move.plot.gg_75,move.plot.gg_115)


grid.arrange(ncol = 2,
             top="Recruitment",
             rec.plot.gg_127, rec.plot.gg_22,rec.plot.gg_75,rec.plot.gg_115)


grid.arrange(ncol = 2,
             top="Biomass",
             bio.plot.gg_127, bio.plot.gg_22,bio.plot.gg_75,bio.plot.gg_115)


grid.arrange(ncol = 2,
             top="Fishing Mortality",
             fmax.plot.gg_127, fmax.plot.gg_22,fmax.plot.gg_75,fmax.plot.gg_115)
...
grid.arrange(ncol = 2,
             top="Movement",
             move.bias.gg_127, move.bias.gg_22,move.bias.gg_75,move.bias.gg_115)


grid.arrange(ncol = 2,
             top="Recruitment",
             rec.bias.gg_127, rec.bias.gg_22,rec.bias.gg_75,rec.bias.gg_115)


grid.arrange(ncol = 2,
             top="Biomass",
             bio.bias.gg_127, bio.bias.gg_22,bio.bias.gg_75,bio.bias.gg_115)


grid.arrange(ncol = 2,
             top="Fishing Mortality",
             fmax.bias.gg_127, fmax.bias.gg_22,fmax.bias.gg_75,fmax.bias.gg_115)
...
runs.to.include.ts<-c(66,75,193,200,198,199)
ssb.med.bias<-sapply(dir_num, function(i) list(get(paste0("ssb.ts_",i))))
ssb.med.bias<-rbindlist(ssb.med.bias)
names.keep.ts<-c(sapply(runs.to.include.ts, function(i) get(paste0("nm_",i))))
ssb.med.bias2<-ssb.med.bias[ssb.med.bias$Scenario %in% names.keep.ts,]
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="1")]<-"Population 1"
ssb.med.bias2$Reg[which(ssb.med.bias2$Reg=="2")]<-"Population 2"
ssb.med.bias2$Scenario<-factor(ssb.med.bias2$Scenario,levels=c("CLM_YR_NO_TAG", 
                                                               "CLM_YR","CLM_YR_TAG_YR",
                                                               "C+O_2YR+2AG_NO_TAG","C+O_2YR+2AG", "C+O_2YR+2AG_TAG_YR"))
...
tiff("For Brian NSAW.tif",width=240,height=190, unit='mm',res=500)
par(mar=c(6,6,6,6))
print(sp.bias.gg)
dev.off()