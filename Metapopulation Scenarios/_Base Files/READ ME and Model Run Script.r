...
# (I like to use AD Studio which comes packaged with the EMACS text editor and syntax highlighting)...if you don't have admin priveleges on your computer then installation can be a pain
# let me know and I can give some tips for working with IT to get it installed if needed
...
wd<<-'D:\\NOAA FILES\\Outreach\\Journal Submissions\\2019\\Journal of Applied Ecology\\movement manuscript\\runs\\No Movement\\Tags\\2YR 2AG Block'
setwd(wd)
...
# to output the value and record it in the report file (or just ask me and I can probably do it real quick)
...
# since this is not a disseminated program I don't have the best error checking built in, sorry if it is a bit confusing...you are the first one outside our group to really look at it
# at some point i can walk you through the input .dat file since that is really the only place you need to change things for each model, it is probably overwelming at first
# but once you get inside my brain a bit, it hopefully makes some sense :p
# also the Goethel and Berger (2017) and Goethel et al. (2019) have some decent descriptions of the framework and dynamics (the latter especially in the SM for the estimation model dynamics)
# further info can be found at our GitHub pages  (most recent paper https://github.com/dgoethel/Spatial-Assessment-Simulator), tagging paper (https://github.com/dgoethel/tag-integrated-model), and general SPASAM site (https://github.com/KateBoz/SPASAM) 
#
