...
wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 0_No Move OM or EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 1_Rand Move OM_No Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 2_Rand Move OM_Cnst Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 3_Rand Move OM_Time Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 4_Rand Move OM_Time+Age Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 
...
wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 6_Onto Move OM_Age Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 
...
wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 8_DD Move OM_No Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 9_DD Move OM_Time Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 

wd<<-'D:\\NOAA FILES\\Research\\COCOCHA\\Hake Model\\Base Model Development\\Metapopulation Scenarios\\_Scenario 10_DD Move OM_Time+Age Move EM'
setwd(wd)
source('SIM_TIM_editing.r') 
